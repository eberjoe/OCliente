...
/**
 * A Classe Servidor vai utilizar o design pattern chamado de 
 * Singleton: Apenas um Objeto desta classe vai existir na 
 * aplicacao.
 * 
 * @author prof-valmor
 */
public class Servidor extends Thread {
    ...
    /**
     * Este atributo se refere a unica instancia desta classe que
     * vai existir.
     */
    private static Servidor instance;
    /**
     * Nome do usuario que vai se conectar na maquina remota. 
     * A maquina remota espera esta informacao para poder adicionar na lista 
     * de usuarios.
     */
    private String nomeDoUsuario;
    
    /**
     * Construtor eh privado porque vai existir 
     * apenas um objeto do tipo Servidor no Cliente.
     * Isso vai ser garantido atraves do uso do metodo 
     * getInstance().
     */
    private Servidor() {
    ...
    /**
     * Esta eh a base do design pattern singleton, tratase de um metod 
     * static, ou seja, eh um metodo da classe. 
     * 
     * Toda vez que for preciso acessar metodos do 
     * Servidor, vai-se utilizar o getInstance.
     ...
     * @throws IOException se houver excessao, vai ser tratada por quem chamou o metodo connect.
     */
